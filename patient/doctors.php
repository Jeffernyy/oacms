...
?>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $spcil_array= $spcil_res->fetch_assoc();
            $spcil_name=$spcil_array["sname"];
            $philhealth_no=$row['docphilhealth_no'];
            $tele=$row['doctel'];
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="philhealth_no" class="input-text" placeholder="philhealth no" value="'.$philhealth_no.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
